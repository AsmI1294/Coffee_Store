  ...
  return (
    <div>
      <div className="card card-side bg-base-100 shadow-sm border-4 border-amber-500 hover:mx-5 justify-between ">
        <figure className="m-2 md:w-24 md:h-32 lg:w-38 lg:h-54 overflow-hidden self-center ">
          <img
            src={photo}
            alt="Broken link"
        ...
        <div className="flex w-5/6 lg:w-4/6 justify-between lg:m-4 space-x-3 ">
          <div className="flex flex-col justify-center p-3 space-y-2 w-2/3">
          ...
          <div className="card-actions justify-end items-center">
            <div className="join join-vertical space-y-3 m-3 w-32">
              <Link
            ...
            {user?.data.userType !== "admin" && (
              <form className="join join-vertical space-y-3 m-3 w-32">
                <input
                  type="text"
                  className="input bg-white border-amber-300 text-lg md:text-xl w-full text-black text-center"
                />
                <button
                  className="btn join-item bg-[#331A15] border-amber-300 hover:bg-amber-300 text-lg md:text-xl"
                  type="submit"
